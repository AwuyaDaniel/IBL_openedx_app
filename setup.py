#!/usr/bin/env python
"""
Package metadata for IBL_openedx_app.
"""
import os
import re
import sys
...
VERSION = get_version('IBL_openedx_app', '__init__.py')
...
setup(
    ...
    version=VERSION,
    description="""extension for openedx_app""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Awuya Daniel',
    author_email='awuyadanielz@gmail.com',
    url='https://github.com/openedx/IBL_openedx_app',
    packages=find_packages(
        include=['IBL_openedx_app', 'IBL_openedx_app.*'],
        exclude=["*tests"],
    ),
