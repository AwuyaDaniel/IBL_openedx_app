...
"""
IBL_openedx_app documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'IBL_openedx_app',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/IBL_openedx_app",
...
#
# html_title = 'IBL_openedx_app v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'extension for openedx_app',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'IBL_openedx_app'),
                os.path.join(root_path, 'IBL_openedx_app/migrations')])
